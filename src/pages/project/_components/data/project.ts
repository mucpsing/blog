...
/**
 * @description: 类型泛型辅助函数,让对象的key可以动态的被ts检查，配合keyof typeof <Object>动态获取对应的key作为枚举类型
 */
function objTypeHelper<T extends Record<string, Tag>>(obj: T): T {
    return obj;
}

// 标签都采用小写
export const TagsObj = objTypeHelper({
    swagger: {
        label: "SwaggerUI",
        description: "",
        color: "#85ea2d",
    ...
    "uni-app": {
        label: "uni-app",
        description: "使用 Vue.js 开发所有前端应用的框架，开发者编写一套代码，可发布到iOS、Android、Web（响应式）、以及各种小程序",
        color: "#2b993a",
    },
    element: {
        label: "ElementUI",
...
export type TagType = keyof typeof TagsObj;
...
export const TagList = Object.keys(TagsObj) as TagType[];
