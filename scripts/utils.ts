 ...
 */
export function createNavItemByDir({ targetPath, includeDirList = [], excludeDirList = [], inDeep = false, prefixUrl = "" }: NavItemParams) {
 ...
 */
export async function createProjectDataByFolder(filepathList: string[], prefixUrl: string[], outputPath: string) {
    const fileInfoList = [];
